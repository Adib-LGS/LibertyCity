...
Code source du Projet 3 de la formation Développeur Web Junior d'OpenClassrooms, 
intitulé "Concevez une carte interactive de location de vélos" Version 1.0 Le projet

Réservez votre vélo en libre service à LibertyCity ! Grâce à cette application web, baséee sur l'API JCDecaux, simulez une réservation de vélo sur la ville de LibertyCity. 
Cette single page application est développée en JavaScript ES6 
et s'articule autour de l'architecture de la Programmation Orientée Objet. 
...
Accompagné d'un décompte de 20 minutes, annonce la confirmation de la réservation. 
